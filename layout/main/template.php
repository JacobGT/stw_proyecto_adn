...
<html>
	<head>
		...
		<link rel="sylesheet" href="/style.cs">
	...
	<body class="w3-black">
		...
		<nav class="w3-sidebar w3-bar-block w3-small w3-hide-small w3-center">
			...
			<img src="https://www.yapasenosinge.syswebgroup.online/assets/imgs/placeholder.svg" style="width:100%">
			<a href="https://www.yapasenosinge.syswebgroup.online/" class="w3-bar-item w3-button w3-padding-large w3-black">
		...
		<div class="w3-padding-large" id="main">
			...
			<div class="w3-content w3-justify w3-text-grey w3-padding-64" id="about">
				...
				<div class="w3-row w3-center w3-padding-16 w3-section w3-light-grey">
					...
					<div class="w3-quarter w3-section">
						...
						Insultos y gritos entre nosotros <span><font size="-3">PD: Excelente ambiente laboral   &semi; &rpar;</font></span>
					</div>
				</div>
				...
				<p><q>wow</q> &emsp;&emsp; <span style="color: #ffff00ff"><font size="+3">5/5</font></span></p>
				<hr>
				<p><span class="w3-large w3-margin-right">Hermana</span> de Rodrigo:</p>
				<p><q>Si no te sales de mi cuarto te pego</q> &emsp;&emsp; <span style="color: #ffff00ff"><font size="+3">5/5</font></span></p>
				<hr>
				<p><span class="w3-large w3-margin-right">Abuelita</span> de Diego:</p>
				<p><q>Que lindo les quedo mijito, no queres galletas?</q> &emsp;&emsp; <span style="color: #ffff00ff"><font size="+3">10/5</font></span></p>
				<hr>
				<p><span class="w3-large w3-margin-right">Vecina</span> de Kevin:</p>
				<p><q>Que haces en mi casa? Salte!</q> &emsp;&emsp; <span style="color: #ffff00ff"><font size="+3">4/5</font></span></p>
				<hr>
				<p><span class="w3-large w3-margin-right">Extraño</span> que se encontr&oacute; Esdras de camino a la U:</p>
				<p><q>Joven, yo solo le pregunte por la hora. Por que me muestra esto?</q> &emsp;&emsp; <span style="color: #ffff00ff"><font size="+3">4.5/5</font></span></p>
				<hr>
				<!-- End About Section -->
			</div>
			...
			<div class="w3-padding-64 w3-content" id="search">
				...
				<form action="/buscar_aduana.php" target="_blank">
			...
			<div class="w3-padding-64 w3-content w3-text-grey" id="pay">
				...
				<div class="w3-section">
					<p>
						<i class="fa fa-map-marker fa-fw w3-text-white w3-xxlarge w3-margin-right"></i> Guatemala, GT</p>
					<p>
						<i class="fa fa-envelope fa-fw w3-text-white w3-xxlarge w3-margin-right"> </i> Email: admin@uspg.syswebgroup.online</p>
				</div><br>
			...
			<footer class="w3-content w3-padding-64 w3-text-grey w3-xlarge">
				<p class="w3-medium">Un servicio de 
					<a href="https://www.yapasenosinge.syswebgroup.online/" target="_blank" class="w3-hover-text-green">Ya Pasenos Inge</a></p>
				<!-- End footer -->
			</footer>
...
<script>
	function popUpBanco()
	{
		alert("Pues puedes irte derechito al banco todo qlero 😡\n" +
		"Exactamente por tomar malas decisiones como estas es que estás como estás😠");
	}
	
	function popUpLinea()
	{
		alert("Hiciste una buena elección... La mejór elección, de hecho... 😊\n" +
